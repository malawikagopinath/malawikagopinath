...
![](images/assignment2(1).png){fig-align="center" width="240"}

![](images/aassignment2(2).png){fig-align="center" width="240"}
...
![](images/Screenshot%202024-10-02%20at%206.42.08%20PM.png){fig-align="center" width="338"}

#### iii. Changing background color

Changed the background color from grey to blue:

Changing the background color of the histogram by replacing col="gray80" with col="lightblue"

![](images/Screenshot%202024-10-02%20at%206.45.39%20PM.png){width="443"}

#### iv. What does the first number in axis() stand for?
